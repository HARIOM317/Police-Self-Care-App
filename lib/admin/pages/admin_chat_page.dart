...
class _AdminChatPageState extends State<AdminChatPage> {
  ...
  // to get current user id and name
  ...
  Future<void> sendMessage(
      String message, int adminId, String adminName) async {
    try {
      ...
      final request = http.Request('OPTIONS', Uri.parse(url))
        ...
        ..body = jsonEncode({
          ...
          'send_by': adminId,
          'images': '',
          'messager_name': adminName,
          'messager_img': adminImg,
  ...
  Future<void> sendChatImage(
      int adminId, String adminName, File? file, String extension) async {
    try {
      if (kDebugMode) {
                  ...
                  padding: EdgeInsets.symmetric(
                      horizontal:
                          (message['message'] == '' || message['message'] == null) &&
                              ...
                              ? 3.3
                              : 15.0,
                      vertical: (message['message'] == '' || message['message'] == null) &&
                              (message['images'] != '' ||
                                  message['images'] != null)
                          ? 10.0
                          : 5.0),
            ...
            children: [
              message['messager_img'] == "" || message['messager_img'] == null
                  ...
                  : CircleAvatar(
                      ...
                      radius: 14,
                      backgroundImage: NetworkImage(message['messager_img']),
                    ),
              Padding(
        ...
        builder: (_) {
          return ListView(
            ...
            children: [
              ...
              // Copy text option or download image option
              (_messages[index]['message'] == '' ||
                          _messages[index]['message'] == null) &&
                      (_messages[index]['images'] != '' ||
                          _messages[index]['images'] != null)
                  ? _OptionItem(
                      icon:
  ...
  Future<void> _deleteMessage(int index) async {
    try {
      ...
      final messageId = message['id']
          .toString(); // Assuming 'id' is the key for the message ID
      final String url = dotenv.env['DELETE_MESSAGE_API']!;

      final request = http.Request('OPTIONS', Uri.parse(url));
      request.headers['Content-Type'] = 'application/json';
      request.body = jsonEncode({"id": messageId});
      ...
      if (response.statusCode == 200) {
        ...
        showSnackbar(context, "Failed to delete message");
      }
    } catch (error) {
      showSnackbar(context, "Error deleting message");
    }
  }
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                bool isMe = _messages[index]['send_by'].toString() ==
                    adminId.toString();
                return isMe
                    ? InkWell(
                        onLongPress: () {
                ...
                MaterialButton(
                  onPressed: () {
                    ...
                    if (message.isNotEmpty) {
                      ...
                      sendMessage(message, adminId, adminName);
                      // Replace 'adminId' with actual user ID
                    }
                    if (kDebugMode) {
          ...
          children: [
            ...
            attachIcon(Icons.camera_alt, "Camera", () async {
              ...
              if (image != null) {
                ...
                await sendChatImage(
                    adminId, adminName, File(image.path), extension);
