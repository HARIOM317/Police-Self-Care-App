...
import 'package:mp_police/user/pages/user_individual_donation.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        allDonations = donations
            .where((donation) => donation['approval_status'] == 'active')
                            ...
                            children: [
                              Padding(
                                ...
                                child: ValueListenableBuilder<bool>(
                                  ...
                                  builder: (context, isHindi, child) {
                                    return Text(
                                      isHindi ? "दान राशि" : "Donated Amount",
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 14),
