    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          writeHeading("Terms and Conditions for Police Self Care"),
          const SizedBox(height: 20,),

          writeSubHeading("Last Updated: 29-02-24"),

          writeHeading("1. ACCEPTANCE OF TERMS"),
          writeDescription("By accessing or using the Police Self Care app, you agree to comply with and be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use the App."),
          ...
          writeDescription("All intellectual property rights in the App, including but not limited to copyrights, trademarks, and patents, are owned by Police Self Care or its licensors. You may not reproduce, distribute, modify, or create derivative works based on the App without our explicit permission."),
